46. write the member functions in c++ to input the number of elements in 
an array and print the reverse sequence of that input elements  using virtual function or late binding.
#include <iostream>    
using namespace std;
class array   
 {    
